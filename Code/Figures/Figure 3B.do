********************************************************************************
* Figure 3B (Estimates of Treatment Effect on Mean Employment Rates Over Nine Years, 
...
foreach var in experimental upper_experimental lower_experimental single_surrogate {
	replace `var' = 100*`var'
}
...
twoway	///
		...
		yscale(range(-2 9)) ///
		xlabel(1(5)36) ///
		legend(order(1 "Actual Mean Treatment Effect Over 36 Quarters" 4 "Surrogate Estimate Using Emp. Rate in Quarter {it:x} Only") position(7) ring(0) cols(1)) ///
